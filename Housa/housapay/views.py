...
# @api_view(['GET'])
# def goods(request):
#     data = {'message':"You're not signed in", "note":"Make sure to register or login"}
#     if request.user.is_authenticated:
#         data = {'message':'No Goods are available'}
...
class Goods(APIView): 
    ...
    def get(self, request, *args, **Kwargs):
        data = {'message':f'{request.user}; No Goods are available'}
        return Response(data=data, status=status.HTTP_204_NO_CONTENT)
